...
# line of Python, but a few readers pointed out that this was impossible to 
# do without using sets that I had not yet discussed on the blog, 
# so you can either choose to use the original 
# directive and read about the set command in Python 3.3, or try to implement this 
...
# print([item for item in (a+b) if item not in ])
print(list({item for item in a+b}))